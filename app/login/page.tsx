            ...
            >
              ...
              <div className="flex items-center justify-between flex-wrap gap-5">
                <div className="flex items-center gap-2">
                  <input
                    className="size-4 rounded border-gray-300 text-primary-600 focus:ring-primary-600 dark:border-slate-600 dark:bg-slate-900"
                    type="checkbox"
                    id="remember"
                    {...register("rememberMe")}
                  />
                ...
                <Link
                  ...
                  className="text-primary-600 transition-colors hover:text-primary-700 hover:underline focus:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300"
                >
