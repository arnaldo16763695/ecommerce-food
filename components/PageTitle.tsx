...
function PageTitle() {
  ...
  return (
    <div className="bg-amber-50 dark:bg-slate-900 text-center flex flex-col gap-1 items-center justify-center min-h-56 px-5">
      <h2 className="text-3xl text-neutral-800 dark:text-slate-200 px-5">
        {pathname === "/shop" && "Tienda"}
        {pathname === "/shopping-cart" && "Carrito de compras"}
      </h2>
